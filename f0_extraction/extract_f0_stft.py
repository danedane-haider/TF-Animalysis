"""Extract F1 contours with STFT spectral peak tracking."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Extract F1 contours by tracking spectral peaks in STFT space.",
    ...
    parser.add_argument(
        ...
        type=str,
        default="stft",
        help="Output label for comparing algorithms, e.g. stft_peak_v2.",
    )
    ...
    parser.add_argument("--n_fft", type=int, default=8192, help="STFT FFT size.")
    parser.add_argument("--win_length", type=int, default=None, help="STFT window length.")
